...
import math
import utils.metrics_new as metrics

__all__ = ['psnr', 'ssim', 'nrms', 'emd', 'peak_nrms']


# metric.py的更新地方，添加了peak_nrmse 和在代码124-176段的代码
...
def calculated_score(threshold_idx=None,
    ...
    # f_csv.writerow([str(threshold_idx)]+[str(i) for i in [1, 2, 3, 4, 5]]) # test
...
def build_roc_prc_metric(threshold=None, dataroot=None, ann_file=None, save_path=None, **kwargs):
    ...
    multi_process_score(out_name='roc_prc.csv', threshold=threshold, label_path=os.path.join(dataroot, label_name),
